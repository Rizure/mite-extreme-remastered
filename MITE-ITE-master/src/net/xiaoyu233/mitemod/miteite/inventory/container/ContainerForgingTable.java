...
public class ContainerForgingTable extends Container {
   ...
   public ContainerForgingTable(ForgingTableSlots slots, EntityPlayer player, int x, int y, int z) {
      ...
      if(!player.worldObj.isRemote){
         ...
         this.tileentity = (TileEntityForgingTable) player.worldObj.getBlockTileEntity(x,y,z);
      }
...
//    }
   ...
   public void switchMode() {
      if (!this.tileentity.isForging()) {
         int new_mode = this.tileentity.getForging_mode() + 1;
         this.tileentity.setForging_mode(new_mode);
      }
   }
 ...
 */
   ...
   public TileEntityForgingTable getTileentity(){
