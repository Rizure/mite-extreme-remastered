...
public class Constant {
   ...
   public static final String MITE_ITE_VERSION = "v1.6-patch19";
   public static final int MITE_ITE_VER_NUM = 16019;
   ...
   public static int nextBlockID_Extend = 287;
...
//   }
   ...
   public static void initItemArray() {
      HELMETS = new ItemArmor[]{Item.helmetLeather, Item.helmetChainCopper, Item.helmetChainIron, Item.helmetChainAncientMetal, Item.helmetRustedIron, Item.helmetChainMithril, Item.helmetCopper, Item.helmetIron, Item.helmetAncientMetal, Item.helmetMithril, Item.helmetAdamantium, Items.helmetVibranium};
      CHESTPLATES = new ItemArmor[]{Item.plateLeather, Item.plateChainCopper, Item.plateChainIron, Item.plateChainAncientMetal, Item.plateRustedIron, Item.plateChainMithril, Item.plateCopper, Item.plateIron, Item.plateAncientMetal, Item.plateMithril, Item.plateAdamantium, Items.cuirassVibranium};
      LEGGINGS = new ItemArmor[]{Item.legsLeather, Item.legsChainCopper, Item.legsChainIron, Item.legsChainAncientMetal, Item.legsRustedIron, Item.legsChainMithril, Item.legsCopper, Item.legsIron, Item.legsAncientMetal, Item.legsMithril, Item.legsAdamantium, Items.leggingsVibranium};
      BOOTS = new ItemArmor[]{Item.bootsLeather, Item.bootsChainCopper, Item.bootsChainIron, Item.bootsChainAncientMetal, Item.bootsRustedIron, Item.bootsChainMithril, Item.bootsCopper, Item.bootsIron, Item.bootsAncientMetal, Item.bootsMithril, Item.bootsAdamantium, Items.bootsVibranium};
      ARMORS = new ItemArmor[][]{HELMETS, CHESTPLATES, LEGGINGS, BOOTS};
      SWORDS = new Item[]{Item.daggerRustedIron, Item.swordRustedIron, Item.swordCopper, Items.clubIron, Item.swordIron, Item.swordAncientMetal, Items.clubMithril, Item.swordMithril, Items.clubAdamantium, Item.swordAdamantium, Items.clubVibranium, Items.swordVibranium};
      TOOLS = new Item[]{Item.shovelRustedIron, Item.axeRustedIron, Item.battleAxeRustedIron, Item.warHammerCopper, Item.battleAxeCopper, Item.warHammerIron, Item.battleAxeIron, Item.warHammerAncientMetal, Item.battleAxeMithril, Item.warHammerMithril, Item.battleAxeAdamantium, Items.battleAxeVibranium};
