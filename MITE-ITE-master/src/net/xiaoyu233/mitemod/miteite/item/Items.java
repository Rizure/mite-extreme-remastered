...
public class Items extends Item {
   ...
   public static final Item blazeCoalPowder = new ItemBlazeCoalPowder(Constant.getNextItemID());
   public static final Item diamondChunk = createInstance(Item.class, new Class[]{int.class, Material.class, String.class}, Constant.getNextItemID(), Material.diamond, "diamond_chunk").setCraftingDifficultyAsComponent(ItemRock.getCraftingDifficultyAsComponent(Material.diamond) / (float) 4);
   public static final Item obsidianStick = createInstance(Item.class, new Class[]{int.class, Material.class, String.class}, Constant.getNextItemID(), Material.obsidian, "obsidian_stick");

   public static final ItemAxe axeVibranium = createInstance(ItemAxe.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.vibranium);
   public static final ItemBattleAxe battleAxeVibranium = createInstance(ItemBattleAxe.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.vibranium);
   public static final ItemArmor bootsVibranium = new ItemBoots(Constant.getNextItemID(), Materials.vibranium, false);
   public static final ItemBow bowVibranium = new ItemBow(Constant.getNextItemID(), Materials.vibranium);
   public static final ItemArmor cuirassVibranium = new ItemCuirass(Constant.getNextItemID(), Materials.vibranium, false);
   public static final ItemDagger daggerVibranium = createInstance(ItemDagger.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.vibranium);
   public static final ItemArmor helmetVibranium = new ItemHelmet(Constant.getNextItemID(), Materials.vibranium, false);
   public static final Item ingotVibranium = createInstance(ItemIngot.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.vibranium);
   public static final ItemArmor leggingsVibranium = new ItemLeggings(Constant.getNextItemID(), Materials.vibranium, false);
   public static final ItemNugget vibraniumNugget = createInstance(ItemNugget.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.vibranium);
   public static final ItemPickaxe pickaxeVibranium = createInstance(ItemPickaxe.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.vibranium);
   public static final ItemShovel shovelVibranium = createInstance(ItemShovel.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.vibranium);
   public static final ItemSword swordVibranium = createInstance(ItemSword.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.vibranium);
   public static final ItemWarHammer warHammerVibranium = createInstance(ItemWarHammer.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.vibranium);

   public static final ItemEnhanceStone enhanceStoneIron = (ItemEnhanceStone) new ItemEnhanceStone(ItemEnhanceStone.Types.iron);
   public static final ItemEnhanceStone enhanceStoneMithril = (ItemEnhanceStone) new ItemEnhanceStone(ItemEnhanceStone.Types.mithril);
   public static final ItemEnhanceStone enhanceStoneAdamantium = (ItemEnhanceStone) new ItemEnhanceStone(ItemEnhanceStone.Types.adamantium);
   public static final ItemEnhanceStone enhanceStoneUniversal = (ItemEnhanceStone) new ItemEnhanceStone(ItemEnhanceStone.Types.universal).setCraftingDifficultyAsComponent(ItemRock.getCraftingDifficultyAsComponent(Material.ender_pearl) * 2f);
   ...
   public static ItemEnhanceGemBox itemEnhanceGemBox = (ItemEnhanceGemBox) (new ItemEnhanceGemBox(Constant.getNextItemID(), "enhance_gem_box_phase1")).setUnlocalizedName("enhance_gem_box_phase1");
   ...
   public static final ItemFood buguDan = (new ItemGAFood(Constant.getNextItemID(), Materials.vegetable, 6, 4, 250, false, false, true, "bugu")).setPlantProduct().setAlwaysEdible();
   ...
   public static final ItemFood xiaoHuanDan = (new ItemGAFood(Constant.getNextItemID(), Materials.bread, 2, 1, 0, false, false, false, "xiaohuan")).setAlwaysEdible();
   public static final ItemFood daHuanDan = (new ItemGAFood(Constant.getNextItemID(), Materials.bread, 6, 3, 250, false, false, false, "dahuan")).setAlwaysEdible();
   public static ItemEnhanceGemBox itemSkillGemBox_L1 = (ItemEnhanceGemBox) (new ItemEnhanceGemBox(Constant.getNextItemID(), "enhance_gem_box_phase2")).setUnlocalizedName("enhance_gem_box_phase2");
   public static ItemEnhanceGemBox itemSkillGemBox_L2 = (ItemEnhanceGemBox) (new ItemEnhanceGemBox(Constant.getNextItemID(), "enhance_gem_box_phase3")).setUnlocalizedName("enhance_gem_box_phase3");

   public static ItemForgingTemplates forgingTemplatesCopper = new ItemForgingTemplates(ItemForgingTemplates.Types.copper);
   public static ItemForgingTemplates forgingTemplatesSilver = new ItemForgingTemplates(ItemForgingTemplates.Types.silver);
   public static ItemForgingTemplates forgingTemplatesGold = new ItemForgingTemplates(ItemForgingTemplates.Types.gold);
   public static ItemForgingTemplates forgingTemplatesIron = new ItemForgingTemplates(ItemForgingTemplates.Types.iron);
   public static ItemForgingTemplates forgingTemplatesAncientMetal = new ItemForgingTemplates(ItemForgingTemplates.Types.ancient_metal);
   public static ItemForgingTemplates forgingTemplatesMithril = new ItemForgingTemplates(ItemForgingTemplates.Types.mithril);
   public static ItemForgingTemplates forgingTemplatesAdamantium = new ItemForgingTemplates(ItemForgingTemplates.Types.adamantium);
   public static ItemForgingTemplates forgingTemplatesVibranium = new ItemForgingTemplates(ItemForgingTemplates.Types.vibranium);

   public static Item fragsStalkerCreeper = createInstance(Item.class, new Class[]{int.class, Material.class, String.class}, Constant.getNextItemID(), Material.frags, "frag/stalker_creeper");

   public static ItemConsumables chibiCreeperBaby = new ItemConsumables(Constant.getNextItemID(),Material.frags,"chibi_creeper_baby");
   public static ItemConsumables chibiCreeperSoul = new ItemConsumables(Constant.getNextItemID(),Material.frags,"chibi_creeper_soul");

   public static final Item ingotMiteGa = createInstance(ItemIngot.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.mitega);
   public static final ItemNugget miteGaNugget = createInstance(ItemNugget.class, new Class[]{int.class, Material.class}, Constant.getNextItemID(), Materials.mitega);
...
//      register("vibranium", vibraniumNugget, CreativeModeTab.tabMaterials);
      ...
      register("vibranium_boots", bootsVibranium);
      register("vibranium_sword", swordVibranium);
      register("vibranium_shovel", shovelVibranium);
      register("vibranium_pickaxe", pickaxeVibranium);
      register("vibranium_axe", axeVibranium);
      register("vibranium_dagger", daggerVibranium);
      register("vibranium_war_hammer", warHammerVibranium);
      register("vibranium_battle_axe", battleAxeVibranium);
      register("diamond_chunk", diamondChunk, CreativeModeTab.tabMaterials);
      register("blaze_coal_powder", blazeCoalPowder, CreativeModeTab.tabMaterials);
      register("bows/vibranium/", bowVibranium).setUnlocalizedName("vibranium_bow");
      register("enhance_stone/iron", enhanceStoneIron, CreativeModeTab.tabMaterials);
      ...
      register("forging_template/gold", forgingTemplatesGold, CreativeModeTab.tabMaterials);
      register("forging_template/iron", forgingTemplatesIron, CreativeModeTab.tabMaterials);
      register("forging_template/ancient_metal", forgingTemplatesAncientMetal, CreativeModeTab.tabMaterials);
      register("forging_template/mithril", forgingTemplatesMithril, CreativeModeTab.tabMaterials);
      register("forging_template/adamantium", forgingTemplatesAdamantium, CreativeModeTab.tabMaterials);
      register("forging_template/vibranium", forgingTemplatesVibranium, CreativeModeTab.tabMaterials);

      register("clubs/iron", clubIron).setUnlocalizedName("iron_club");
      register("clubs/ancient_metal", clubAncientMetal).setUnlocalizedName("ancient_metal_club");
      register("clubs/mithril", clubMithril).setUnlocalizedName("mithril_club");
      register("clubs/adamantium", clubAdamantium).setUnlocalizedName("adamantium_club");
      register("clubs/vibranium", clubVibranium).setUnlocalizedName("vibranium_club");

      register("stack_torch", Stack_Torch).setUnlocalizedName("stack_torch").setMaxStackSize(16).setCraftingDifficultyAsComponent(25.0F);
      register("bunch_torch", Bunch_Torch).setUnlocalizedName("bunch_torch").setMaxStackSize(64).setCraftingDifficultyAsComponent(25.0F);

      register("lava_in_pipes", lavaInPipes).setUnlocalizedName("lava_in_pipes").setLowestCraftingDifficultyToProduce(25.0F);
      register("ring_killer/ring_killer_copper", ringKillerCopper).setUnlocalizedName("ring_killer_copper").setLowestCraftingDifficultyToProduce(25.0F);
      register("ring_killer/ring_killer_iron", ringKillerIron).setUnlocalizedName("ring_killer_iron").setLowestCraftingDifficultyToProduce(25.0F);
      register("ring_killer/ring_killer_ancient", ringKillerAncient).setUnlocalizedName("ring_killer_ancient").setLowestCraftingDifficultyToProduce(25.0F);
      register("ring_killer/ring_killer_mithril", ringKillerMithril).setUnlocalizedName("ring_killer_mithril").setLowestCraftingDifficultyToProduce(25.0F);
      register("ring_killer/ring_killer_adamantium", ringKillerAdamantium).setUnlocalizedName("ring_killer_adamantium").setLowestCraftingDifficultyToProduce(25.0F);
      register("ring_killer/ring_killer_vibranium", ringKillerVibranium).setUnlocalizedName("ring_killer_vibranium").setLowestCraftingDifficultyToProduce(25.0F);

      register("voucher/voucher_exchanger", voucherPhase).setUnlocalizedName("voucher_exchanger").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_door", voucherDestruction).setUnlocalizedName("voucher_door").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_zombie_lord", voucherOverlord).setUnlocalizedName("voucher_zombie_lord").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_annihilation_skeleton", voucherStrike).setUnlocalizedName("voucher_annihilation_skeleton").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_pigman", voucherCluster).setUnlocalizedName("voucher_pigman").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_witch", voucherMagic).setUnlocalizedName("voucher_witch").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_core", voucherCore).setUnlocalizedName("voucher_core").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_fishing", voucherFishing).setUnlocalizedName("voucher_fishing").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_planting", voucherPlanting).setUnlocalizedName("voucher_planting").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_villager", voucherVillager).setUnlocalizedName("voucher_villager").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_club_core", voucherClubCore).setUnlocalizedName("voucher_club_core").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_spider", voucherSpider).setUnlocalizedName("voucher_spider").setLowestCraftingDifficultyToProduce(25.0F);
      register("voucher/voucher_guard", voucherGuard).setUnlocalizedName("voucher_guard").setLowestCraftingDifficultyToProduce(25.0F);

      register("dynamic_core/1", itemDynamicCoreIron).setUnlocalizedName("dynamic_core_iron").setLowestCraftingDifficultyToProduce(25.0F);
      register("dynamic_core/2", itemDynamicCoreAncient_metal).setUnlocalizedName("dynamic_core_ancient_metal").setLowestCraftingDifficultyToProduce(25.0F);
      register("dynamic_core/3", itemDynamicCoreMithril).setUnlocalizedName("dynamic_core_mithril").setLowestCraftingDifficultyToProduce(25.0F);
      register("dynamic_core/4", itemDynamicCoreAdamantium).setUnlocalizedName("dynamic_core_adamantium").setLowestCraftingDifficultyToProduce(25.0F);
      register("dynamic_core/5", itemDynamicCoreVibranium).setUnlocalizedName("dynamic_core_vibranium").setLowestCraftingDifficultyToProduce(25.0F);

      register("regeneration_core/1", itemRegenerationCoreIron).setUnlocalizedName("regeneration_core_iron").setLowestCraftingDifficultyToProduce(25.0F);
      register("regeneration_core/2", itemRegenerationCoreAncient_metal).setUnlocalizedName("regeneration_core_ancient_metal").setLowestCraftingDifficultyToProduce(25.0F);
      register("regeneration_core/3", itemRegenerationCoreMithril).setUnlocalizedName("regeneration_core_mithril").setLowestCraftingDifficultyToProduce(25.0F);
      register("regeneration_core/4", itemRegenerationCoreAdamantium).setUnlocalizedName("regeneration_core_adamantium").setLowestCraftingDifficultyToProduce(25.0F);
      register("regeneration_core/5", itemRegenerationCoreVibranium).setUnlocalizedName("regeneration_core_vibranium").setLowestCraftingDifficultyToProduce(25.0F);

      register("guard_core/1", itemGuardCoreIron).setUnlocalizedName("guard_core_iron").setLowestCraftingDifficultyToProduce(25.0F);
      register("guard_core/2", itemGuardCoreAncient_metal).setUnlocalizedName("guard_core_ancient_metal").setLowestCraftingDifficultyToProduce(25.0F);
      register("guard_core/3", itemGuardCoreMithril).setUnlocalizedName("guard_core_mithril").setLowestCraftingDifficultyToProduce(25.0F);
      register("guard_core/4", itemGuardCoreAdamantium).setUnlocalizedName("guard_core_adamantium").setLowestCraftingDifficultyToProduce(25.0F);
      register("guard_core/5", itemGuardCoreVibranium).setUnlocalizedName("guard_core_vibranium").setLowestCraftingDifficultyToProduce(25.0F);

      register("fancy_red", fancyRed).setUnlocalizedName("fancy_red").setLowestCraftingDifficultyToProduce(25.0F);
      register("fancy_red_shard", shardFancyRed).setUnlocalizedName("shardFancyRed");
      register("gem/enhance_gem/", itemEnhanceGem).setUnlocalizedName("enhance_gem_phase1").setLowestCraftingDifficultyToProduce(25.0F);
      register("gem/enhance_gem/", itemEnhanceGem2).setUnlocalizedName("enhance_gem_phase2").setLowestCraftingDifficultyToProduce(25.0F);
      register("gem/enhance_gem/", itemEnhanceGem3).setUnlocalizedName("enhance_gem_phase3").setLowestCraftingDifficultyToProduce(25.0F);
      register("gem/enhance_gem/", itemEnhanceGem4).setUnlocalizedName("enhance_gem_phase4").setLowestCraftingDifficultyToProduce(25.0F);
      register("gem/enhance_gem/", itemEnhanceGem5).setUnlocalizedName("enhance_gem_phase5").setLowestCraftingDifficultyToProduce(25.0F);
      register("gem/enhance_gem/", itemEnhanceGem6).setUnlocalizedName("enhance_gem_phase6").setLowestCraftingDifficultyToProduce(25.0F);
...
//      register("ga",miteGaNugget, CreativeModeTab.tabMaterials);
      ...
      register("enhance_gem_box_phase1", itemEnhanceGemBox);
      register("enhance_gem_box_phase2", itemSkillGemBox_L1);
      register("enhance_gem_box_phase3", itemSkillGemBox_L2);

      register("frag/stalker_creeper", fragsStalkerCreeper);

      register("chibi_creeper_baby",chibiCreeperBaby);
   ...
   public static void registerRecipes(RecipeRegister register) {
      Material[] materials = new Material[]{Material.copper, Material.silver, Material.gold, Material.iron, Material.ancient_metal, Material.mithril, Material.adamantium, Materials.vibranium};
      for (int i = 0; i < materials.length; i++) {
         for (int id = Items.powder_dark.itemID; id <= Items.powder_earth.itemID; id++) {
            register.registerShapedRecipe(new ItemStack(Items.powder_metal, 1), true, new Object[]{"###", "#*#", "###", '#', Item.getMatchingItem(ItemNugget.class, materials[i]), '*', getItem(id)});
         }
      }
      ...
      register.registerShapelessRecipe(new ItemStack(Items.cubeSugar, 1), true, new Object[]{Item.sugar, Item.sugar, Item.sugar, Item.sugar});
      register.registerShapelessRecipe(new ItemStack(Items.spicyStrip, 8), true, new Object[]{Item.rottenFlesh, Item.rottenFlesh, Item.rottenFlesh, Item.rottenFlesh});
      register.registerShapelessRecipe(new ItemStack(Items.riskyAgent, 1), true, new Object[]{Items.zombieBrain, Items.zombieBrain, Items.zombieBrain, Block.plantYellow});
      register.registerShapelessRecipe(new ItemStack(Items.c4, 4), true, new Object[]{Block.tnt, Block.pressurePlatePlanks});
      register.registerShapelessRecipe(new ItemStack(Items.grenade, 5), true, new Object[]{Block.tnt, Block.woodenButton});
      register.registerShapelessRecipe(new ItemStack(Items.badApple, 1), true, new Object[]{new ItemStack(Block.leaves, 1, 0), new ItemStack(Block.leaves, 1, 1), new ItemStack(Block.leaves, 1, 2), new ItemStack(Block.leaves, 1, 3)});

      register.registerShapelessRecipe(new ItemStack(Items.miteGaNugget,9),true,Items.ingotMiteGa);
      register.registerShapelessRecipe(new ItemStack(Items.ingotMiteGa),true,new ItemStack(Items.miteGaNugget,9));
      register.registerShapelessRecipe(new ItemStack(Items.psiCore),true,new ItemStack(Items.miteGaNugget,4));
      register.registerShapelessRecipe(new ItemStack(Items.ingotMiteGa),true,
              Items.powder_wood, Items.powder_earth, Items.powder_metal,
              Items.powder_blaze, Items.powder_dark, Items.powder_wind,
              Items.powder_freeze, Items.powder_liquid, Items.powder_thunder
              );
      ...
      register.registerShapedRecipe(new ItemStack(itemDynamicCoreVibranium, 1), true, new Object[]{"ABA", "BCB", "DBD", 'A', Items.ingotVibranium, 'D', Blocks.blockVibranium, 'B', Blocks.glass, 'C', Items.itemDynamicCoreAdamantium});
      ...
      register.registerShapedRecipe(new ItemStack(itemRegenerationCoreVibranium, 1), true, new Object[]{"ABA", "BCB", "DBD", 'A', Items.ingotVibranium, 'D', Blocks.blockVibranium, 'B', Blocks.glass, 'C', Items.itemRegenerationCoreAdamantium});
      ...
      register.registerShapedRecipe(new ItemStack(itemGuardCoreVibranium, 1), true, new Object[]{"ABA", "BCB", "DBD", 'A', Items.ingotVibranium, 'D', Blocks.blockVibranium, 'B', Blocks.glass, 'C', Items.itemGuardCoreAdamantium});

      register.registerShapedRecipe(new ItemStack(Items.miteGaFan),true,
              "P  ",
              "SC ",
              "SSP",
              'C',Items.psiCore,
      ...
      register.registerShapelessRecipe(new ItemStack(Items.final_key, 1), true, Items.cracked_key, Items.vibraniumNugget, Items.vibraniumNugget, Items.vibraniumNugget);
      ...
      if (Configs.wenscConfig.isRecipeRingKiller.ConfigValue) {
         for (int i = 0; i <= 2; ++i) {
            ...
            register.registerShapedRecipe(new ItemStack(ringKillerVibranium, 1, i), true, new Object[]{"###", "#*#", "###", '#', swordVibranium, '*', new ItemStack(ringKillerAdamantium, 1, i)});
            if (i == 2) {
      ...
      register.registerShapedRecipe(new ItemStack(obsidianStick), true, "#", "#", '#', Block.obsidian);
      register.registerShapedRecipe(new ItemStack(ingotVibranium),
              true,
              "NIN",
              "IDI",
              "NIN",
              ...
              'D',
              Items.voucherCore);
      register.registerShapelessRecipe(new ItemStack(vibraniumNugget, 9), true, ingotVibranium);
      register.registerShapelessRecipe(new ItemStack(ingotVibranium), true, new ItemStack(vibraniumNugget, 9));
      ...
      register.registerShapelessRecipe(new ItemStack(xiaoHuanDan, 3), true, Item.bread);

      for (int subtype = 2; subtype < 10; subtype ++){
         if(subtype < 6){
            register.registerShapelessRecipe(new ItemStack(Item.knifeFlint),false, new ItemStack(Blocks.blockExtendedToolbench,1,subtype));
         }else {
            register.registerShapelessRecipe(new ItemStack(Item.knifeObsidian),false, new ItemStack(Blocks.blockExtendedToolbench,1,subtype));
         }
      }
      ...
      register.registerShapedRecipe(new ItemStack(shovelVibranium),
              true,
              "#",
              "A",
              "S",
      ...
      register.registerShapedRecipe(new ItemStack(swordVibranium),
              true,
              " # ",
              " # ",
              " A ",
              ...
              'S', obsidianStick,
              'A', swordAncientMetal);
      register.registerShapedRecipe(new ItemStack(axeVibranium),
              true,
              "##",
              "A#",
              "S ",
              ...
              'S', obsidianStick,
              'A', axeAncientMetal);
      register.registerShapedRecipe(new ItemStack(daggerVibranium),
              true,
              "I",
              "A",
              'I', ingotVibranium,
              'A', daggerAncientMetal);
      register.registerShapedRecipe(new ItemStack(warHammerVibranium),
              true,
              "III",
              "IAI",
              " S ",
      ...
      register.registerShapedRecipe(new ItemStack(battleAxeVibranium),
              true,
              "I I",
              "IAI",
              " S ",
      ...
      register.registerShapelessRecipe(new ItemStack(ingotVibranium, 9), true, Blocks.blockVibranium);
      register.registerShapelessRecipe(new ItemStack(Item.diamond),
              ...
              diamondChunk,
              diamondChunk);
      register.registerShapedRecipe(new ItemStack(blazeCoalPowder),
              true,
              " B ",
              "BCB",
              " B ",
              'B', Item.blazePowder,
              'C', Item.coal);
      RecipesFurnace.smelting().addSmelting(Block.coalBlock.blockID, new ItemStack(diamondChunk));
      ...
      register.registerShapedRecipe(new ItemStack(bowVibranium),
              true,
              "NSL",
              "AVL",
              "NSL",
      ...
      register.registerShapedRecipe(new ItemStack(enhanceStoneIron),
              ...
              'C', Item.ingotCopper,
              'S', Item.ingotSilver);
      register.registerShapelessRecipe(new ItemStack(enhanceStoneIron, 9), true, Blocks.blockEnhanceStoneIron);
      register.registerShapedRecipe(new ItemStack(enhanceStoneMithril),
              true,
              " I ",
              "GMG",
              " I ",
              ...
              'G', Item.ingotGold,
              'M', Item.ingotMithril);
      register.registerShapelessRecipe(new ItemStack(enhanceStoneMithril, 9), true, Blocks.blockEnhanceStoneMithril);
      register.registerShapedRecipe(new ItemStack(enhanceStoneAdamantium),
              true,
              " D ",
              "MAM",
              " R ",
      ...
      register.registerShapedRecipe(new ItemStack(enhanceStoneVibranium),
              ...
              'D', Item.diamond,
              'M', Item.ingotMithril,
              'V', Items.ingotVibranium);
      register.registerShapedRecipe(new ItemStack(enhanceStoneUniversal),
              true,
              "gDg",
              "bTb",
              "BEB",
      ...
      for (int i = 0; i < materials.length; i++) {
         register.registerShapedRecipe(new ItemStack(Item.getMatchingItem(ItemForgingTemplates.class, materials[i])), true,
                 new Object[]{
                         "###",
                         "#*#",
                         "###",
                         '#', Item.brick,
                         '*', Item.getMatchingItem(ItemIngot.class, materials[i])});
         if(i + 1 < materials.length && i > 2){
            register.registerShapedRecipe(new ItemStack(Item.getMatchingItem(ItemForgingTemplates.class, materials[i + 1])), true,
                    new Object[]{
                            "###",
                            "#*#",
                            "###",
                            '#', Item.getMatchingItem(ItemIngot.class, materials[i + 1]),
                            '*', Item.getMatchingItem(ItemForgingTemplates.class, materials[i])}).extendsNBT();
         }else if(i <= 2){
            register.registerShapedRecipe(new ItemStack(Item.getMatchingItem(ItemForgingTemplates.class, Material.iron)), true,
                    new Object[]{
                            "###",
                            "#*#",
                            "###",
                            '#', Item.getMatchingItem(ItemIngot.class, Material.iron),
                            '*', Item.getMatchingItem(ItemForgingTemplates.class, materials[i])}).extendsNBT();
         }
         if(i > 3){
            register.registerShapelessRecipe(new ItemStack(Item.getMatchingItem(ItemForgingTemplates.class, materials[i]), 2), true,
                    new Object[]{
                            Item.diamond,
                            Items.fancyRed,
                            Items.emerald,
                            Items.enhanceStoneUniversal,
                            Item.diamond,
                            Items.fancyRed,
                            Items.emerald,
                            Items.enhanceStoneUniversal,
                            Item.getMatchingItem(ItemForgingTemplates.class, materials[i])
            }).extendsNBT();
         }
      }

      register.registerShapedRecipe(new ItemStack(Item.stick,1), false,
              "I",
              "I",
              'I',Items.bamboo);
   ...
   public static Item fetchingStickByMaterial(Material material) {
      return material == Materials.vibranium ? obsidianStick : Item.stick;
   }
}
