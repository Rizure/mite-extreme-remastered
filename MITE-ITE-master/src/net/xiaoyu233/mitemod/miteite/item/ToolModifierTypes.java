...
public enum ToolModifierTypes implements ItemModifierTypes {
   ...
   INVINCIBLE(1.25f, "坚忍", EnumModifierQuality.Uncommon, (ToolModifierTypes::isWeapon), 4),
   ...
   STEADY(0.15F, "老成", EnumModifierQuality.Rare, (ToolModifierTypes::isNotWeapon), 4),
   TREASURING(0.05f, "淘金热", EnumModifierQuality.Rare, ToolModifierTypes::isFarmingTools, 4),
   ...
   URBAN_LEGEND(0.25f, "都市传说", EnumModifierQuality.Epic, ToolModifierTypes::isWeapon, 4),
   GEOLOGY(0.25f, "地质学", EnumModifierQuality.Epic, itemStack -> itemStack.getItem() instanceof ItemPickaxe && WithoutMiningModifier(itemStack, 0), 4),
   BLESS_OF_NATURE(0.0375f, "自然祝福", EnumModifierQuality.Legend, (stack -> true), 4),
   PURGATORY(0.15f, "炼狱", EnumModifierQuality.Legend, ToolModifierTypes::isWeapon, 4),
...
//    PLUNDER(0.02f,"劫掠",EnumModifierQuality.Legend, ToolModifierTypes::isWeapon, 4)
   ...
   public static boolean isFarmingTools(ItemStack stack) {
      Item item = stack.getItem();
