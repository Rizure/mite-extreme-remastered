...
public enum ArmorModifierTypes implements ItemModifierTypes {
   ...
   DENSE(0.04375F, "致密", EnumModifierQuality.Uncommon, 4, (stack -> true)),
   ...
   ENERGETIC(0.03f, "海纳百川", EnumModifierQuality.Epic, 4, itemStack -> itemStack.getItem() instanceof ItemLeggings),
