...
public class ItemEnhanceGem extends Item {
   ...
   public ItemEnhanceGem(int id, int level) {
      super(id, Material.diamond, "gem/enhance_gem/");
      this.gemLevel = (level + 3) * level / 4;
      this.textureOffset = level;
   ...
   public void a(mt par1IconRegister) {
      ...
      for (int var2 = 0; var2 < GemModifierTypes.values().length; ++var2) {
         this.field_94586_c[var2] = par1IconRegister.a(this.A() + GemModifierTypes.values()[var2].gemName + "/phase" + textureOffset);
      }
   }
