...
public class ForgingRecipe {
   ...
   public ForgingRecipe(List<IFaultFeedback> faultFeedback, List<ItemStack> materialsToUpgrade, Material material, int levelToUpgrade, int timeReq, int hammerDurabilityCost, int axeDurabilityCost, int chanceOfFailure, ForgingTableLevel forgingTableLevelReq, EnumQuality qualityReward, boolean shouldUpgradeForgingLevel, int forging_mode) {
      ...
      this.forging_mode = forging_mode;
   }
   ...
   public static class Builder {
      ...
      public Builder setForging_Mode(int mode){
         this.forging_mode = mode;
         return this;
      }

      public void build(Consumer<ForgingRecipe> registerer) {
         registerer.accept(new ForgingRecipe(faultFeedback, materialsToUpgrade, material, levelToUpgrade, timeReq, hammerDurabilityCost, axeDurabilityCost, chanceOfFailure, forgingTableLevelReq, qualityReward, shouldUpgradeForgingLevel, forging_mode));
      }
   }
