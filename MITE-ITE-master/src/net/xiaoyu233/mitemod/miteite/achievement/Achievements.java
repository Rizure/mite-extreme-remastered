...
public class Achievements {
   ...
   public static void registerAchievements() {
      vibraniumIngot = new Achievement(getNextAchievementID(), "vibraniumIngot", -2, 17, Items.ingotVibranium, AchievementList.adamantiumIngot).registerAchievement();
      wearAllVibraniumPlateArmor = new Achievement(getNextAchievementID(), "vibraniumArmor", 12, 1, Items.cuirassVibranium, AchievementList.wearAllAdamantiumPlateArmor).setSpecial().registerAchievement();
      ...
      killZombieBoss = new Achievement(getNextAchievementID(), "killZombieBoss", 0, 11, Items.warHammerVibranium, AchievementList.portal).registerAchievement();
