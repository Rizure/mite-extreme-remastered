...
public class MITEITEEvents {
      ...
      if (Minecraft.inDevMode() || player.isOp()) {
         ...
         if (par2Str.startsWith("itemlevel reset")) {
            ...
            if (itemStack.stackTagCompound != null) {
               ...
               if (compound.hasKey("using_level")) {
                  compound.removeTag("using_level");
               }
               if (compound.hasKey("using_exp")) {
                  compound.removeTag("using_exp");
               }
         ...
         if (par2Str.startsWith("itemlevel setLevel")) {
            ...
            if (itemStack.stackTagCompound != null) {
               compound = itemStack.stackTagCompound;
               if (compound.hasKey("using_level")) {
                  compound.setInteger("using_level", Integer.parseInt(par2Str.substring(19)));
                  event.setExecuteSuccess(true);
               }
            }
         }
         ...
         if (par2Str.startsWith("itemlevel setXp")) {
            ...
            if (itemStack.stackTagCompound != null) {
               compound = itemStack.stackTagCompound;
               if (compound.hasKey("using_exp")) {
                  compound.setInteger("using_exp", Integer.parseInt(par2Str.substring(16)));
                  event.setExecuteSuccess(true);
               }
            }
         }
   ...
   public void onPacketRegister(PacketRegisterEvent event) {
      ...
      event.register(141,false,true, CPacketSwitchForgingTableMode.class);
      event.register(142,true,false,SPacketUpdateForgingTableModeState.class);
   }
