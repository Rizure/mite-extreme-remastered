...
public class EntityExchanger extends EntitySkeleton {
   ...
   public void teleportToTarget(double par1, double par3, double par5) {
      ...
      this.worldObj.blockFX(EnumBlockFX.particle_trail, x, y, z, (new SignalData()).setByte(EnumParticle.portal_nether.ordinal()).setShort((int) (8.0D * distance)).setApproxPosition((double) MathHelper.floor_double(var7), (double) MathHelper.floor_double(var9), (double) MathHelper.floor_double(var11)));
      this.worldObj.blockFX(EnumBlockFX.particle_trail, x, y + 1, z, (new SignalData()).setByte(EnumParticle.portal_nether.ordinal()).setShort((int) (8.0D * distance)).setApproxPosition((double) MathHelper.floor_double(var7), (double) MathHelper.floor_double(var9 + 1.0D), (double) MathHelper.floor_double(var11)));
