...
public class EntityFinalZombieBoss extends EntityZombieBoss {
   ...
   protected void addRandomEquipment() {
      ItemStack Weapon = new ItemStack(Items.battleAxeVibranium);
      ...
      this.setHelmet(new ItemStack(Items.helmetVibranium).setItemDamage(0));
      this.setCuirass(new ItemStack(Items.cuirassVibranium).setItemDamage(0));
      this.setLeggings(new ItemStack(Items.leggingsVibranium).setItemDamage(0));
      this.setBoots(new ItemStack(Items.bootsVibranium).setItemDamage(0));
      this.getBoots().addEnchantment(Enchantment.protection, 5);
      ...
      this.getHelmet().addEnchantment(Enchantment.protection, 5);
   ...
   protected void applyEntityAttributes() {
      ...
      this.setEntityAttribute(GenericAttributes.maxHealth, Math.min(1500, 800 * Constant.getBossMobModifier("Health", day)));
   }
}
