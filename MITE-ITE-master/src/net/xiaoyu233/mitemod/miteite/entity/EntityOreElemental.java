...
public class EntityOreElemental extends EntityEarthElemental {
   ...
   protected void addRandomEquipment() {
      ...
      this.setHeldItemStack((new ItemStack(Items.pickaxeVibranium, 1)).randomizeForMob(this, day > 64));
      this.initRandomOreHead();
      if (this.danger_level > 7) {
         this.setCuirass(new ItemStack(Items.cuirassVibranium, 1).randomizeForMob(this, day > 64));
      }
      this.setLeggings((new ItemStack(Items.leggingsVibranium, 1)).randomizeForMob(this, day > 64));
      this.setBoots((new ItemStack(Items.bootsVibranium, 1)).randomizeForMob(this, day > 64));
   }
