...
public class EntityLargeFireballNonExplodeBlock extends EntityLargeFirebal {
   public EntityLargeFireballNonExplodeBlock(World world, EntityLiving shooter, Vec3D target, float initial_distance) {
      super(world, shooter, target, initial_distance);
   }

   public EntityLargeFireballNonExplodeBlock(World world, EntityLiving shooter, Vec3D origin, Vec3D target, float initial_distance) {
