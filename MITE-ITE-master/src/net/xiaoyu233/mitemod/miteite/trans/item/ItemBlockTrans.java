...
public abstract class ItemBlockTrans extends Item {
   ...
   public String getItemDisplayName(ItemStack item_stack) {
      ...
      } else if(item_stack != null && this.getBlock() == Blocks.blockExtendedToolbench){
         return Translator.get("tile.toolbench." + BlockExtendedToolbench.getToolMaterial(item_stack.getItemSubtype()).getName() + ".name");
      }
