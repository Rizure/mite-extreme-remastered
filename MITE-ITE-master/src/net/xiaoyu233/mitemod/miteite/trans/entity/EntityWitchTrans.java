...
public abstract class EntityWitchTrans extends EntityMonster {
   @Shadow
   @Final
   private static UUID field_110184_bp;
   @Shadow
   @Final
   private static AttributeModifier field_110185_bq;
   @Shadow
   @Final
   ...
   @Shadow
   private EntityLiving summon_wolf_target;
   @Shadow
   ...
   @Shadow
   protected abstract int summonWolves();

   @Shadow
   public abstract void setAggressive(boolean par1);
