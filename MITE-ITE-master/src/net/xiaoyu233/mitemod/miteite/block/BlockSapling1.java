...
public class BlockSapling1 extends BlockPlant {
   ...
   private void growTree(World par1World, int par2, int par3, int par4, Random par5Random) {
      ...
      Object var7;
      if(var6 == 1){
         var7 = new WorldGenCherry(false,1 + par5Random.nextInt(3),2 + par5Random.nextInt(3),5 + par5Random.nextInt(3));
      }else {
         var7 = new WorldGenTreesWithTreeId(false, 4, Blocks.wood1, var6, Blocks.leaves1, var6, false);
      }
      int var8 = 0;
      int var9 = 0;
      boolean var10 = false;
