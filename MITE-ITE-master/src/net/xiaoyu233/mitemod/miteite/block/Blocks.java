...
import static net.xiaoyu233.mitemod.miteite.item.Items.ingotVibranium;
...
public class Blocks extends Block {
   ...
   public static final BlockOreBlock blockFancyRed = new BlockOreBlock(getNextBlockIDExtend(), Material.diamond);
   public static final BlockHeadStone blockHeadStone = new BlockHeadStone(getNextBlockIDExtend(), Material.obsidian);
   public static final BlockOreBlock blockEnhanceStoneIron = new BlockOreBlock(getNextBlockIDExtend(), Materials.iron);
   public static final BlockOreBlock blockEnhanceStoneMithril = new BlockOreBlock(getNextBlockIDExtend(), Materials.mithril);
   ...
   public static int getNextBlockIDExtend() {
      return Constant.nextBlockID_Extend++;
   }
   ...
   public static void registerBlocks() {
      ...
      registerItemBlock(blockEnhanceStoneIron, "enhance_stone_iron_block");
      registerItemBlock(blockEnhanceStoneMithril, "enhance_stone_mithril_block");
...
//      registerItemBlock(flowerPotSapling,"flowerPot");
   ...
   public static void registerRecipes(RecipeRegister register) {
      ...
      register.registerShapelessRecipe(new ItemStack(blockVibranium), true,
              ingotVibranium, ingotVibranium, ingotVibranium,
              ingotVibranium, ingotVibranium, ingotVibranium,
              ingotVibranium, ingotVibranium, ingotVibranium
      );
      ...
      for (int i = 0; i < GemModifierTypes.values().length; i++) {
         register.registerShapedRecipe(new ItemStack(Blocks.gemSetting, 1, 0), true,
                 "AAA",
                 "BCB",
                 "BBB",
                 'A', Items.ingotIron,
      ...
      registerForgingTableUpgradeRecipes(register, ForgingTableLevel.ADAMANTIUM, ingotVibranium);

      for(int subtype = 2; subtype < 10; subtype++){
         register.registerShapedRecipe(new ItemStack(Blocks.blockExtendedToolbench,1,subtype),true,
                 new Object[]{
                         "R#",
                         "SL",
                         'R',subtype < 6 ? Item.flint : Block.obsidian,
                         '#', Item.sinew,
                         'S', Item.stick,
...
//              'I', ingotVibranium,
//              'P',Block.planks);
//      register.registerRestrictShapedRecipe(new ItemStack(Blocks.blockExtendedToolbench,1,1),true,true,
//              "LI",
//              "PS",
//              'L',Item.leather,
//              'S',Item.stick,
...
//              'P',Block.planks);
      ...
      RecipesFurnace.smelting().addSmelting(Blocks.blockEnhanceStoneIron.blockID, new ItemStack(Items.itemSkillGemBox_L1));
      RecipesFurnace.smelting().addSmelting(Blocks.blockEnhanceStoneMithril.blockID, new ItemStack(Items.itemSkillGemBox_L2));
